...
export default function Header(){
  return <>
    ...
    <header className="header"><div className="container nav">
      <Link className="brand" href="/"><img src="/img_star/logon.png" alt="ES Elétrica RJ"/><div>ES <span>Elétrica RJ</span><small style={{display:'block',fontSize:11,letterSpacing:1,color:'#64748b'}}>Tecnologia e Sustentabilidade</small></div></Link>
      ...
      <a className="btn btn-primary" href="https://wa.me/5521998415889" target="_blank">WhatsApp</a>
    </div></header>
  </>
}
